...
##   id = "/subscriptions/.../virtualMachines/ST-TFSServer"
## }

## import {
##   to = azurerm_virtual_machine.imported-vms["ST-UTILSRV01"]
##   id = "/subscriptions/.../virtualMachines/ST-UTILSRV01"
## }

## import {
##   to = azurerm_virtual_machine.imported-vms["ST-UTILSRV03"]
##   id = "/subscriptions/.../virtualMachines/ST-UTILSRV03"
## }

## import {
##   to = azurerm_virtual_machine.imported-vms["ST-WEB01"]
##   id = "/subscriptions/.../virtualMachines/ST-WEB01"
## }
...
# --- STINB2-SQL01 VM ---
import {
  to = azurerm_virtual_machine.imported-vms["STINB2-SQL01"]
  id = "/subscriptions/<subid>/resourceGroups/int-staging-rg/providers/Microsoft.Compute/virtualMachines/STINB2-SQL01"
}

# --- STINB2-SQL01 Disks ---
import {
  to = azurerm_managed_disk.imported-disks["STINB2-SQL01-disk-SQLVDATA01"]
  id = "/subscriptions/<subid>/resourceGroups/int-staging-rg/providers/Microsoft.Compute/disks/STINB2-SQL01-disk-SQLVDATA01"
}

import {
  to = azurerm_managed_disk.imported-disks["STINB2-SQL01-disk-SQLVTEMPDB"]
  id = "/subscriptions/<subid>/resourceGroups/int-staging-rg/providers/Microsoft.Compute/disks/STINB2-SQL01-disk-SQLVTEMPDB"
}

import {
  to = azurerm_managed_disk.imported-disks["inb2-sql_temp_01"]
  id = "/subscriptions/<subid>/resourceGroups/int-staging-rg/providers/Microsoft.Compute/disks/inb2-sql_temp_01"
}

import {
  to = azurerm_managed_disk.imported-disks["STINB2-SQL01-desk-SQLVMDATA02"]
  id = "/subscriptions/<subid>/resourceGroups/int-staging-rg/providers/Microsoft.Compute/disks/STINB2-SQL01-desk-SQLVMDATA02"
}

import {
  to = azurerm_managed_disk.imported-disks["STINB2-SQL01-disk-SQLVMLOGS01"]
  id = "/subscriptions/<subid>/resourceGroups/int-staging-rg/providers/Microsoft.Compute/disks/STINB2-SQL01-disk-SQLVMLOGS01"
}